$("#SetFen").click(function() {         //This allows for the FEN function to work once I FEN string has been pasted it will generate the designated position
...
function PieceIsOnSq(sq, top,left) {
    ...
    if( (RanksBrd[sq] == 7 - Math.round(top/90) ) &&
                FilesBrd[sq] == Math.round(left/90) ) {
                return BOOL.TRUE;
        }
...
function PreSearch() {   //MIGHT REMOVE
